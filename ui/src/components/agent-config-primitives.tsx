...
export const help: Record<string, string> = {
  ...
  localModelProvider: "Route OpenAI-compatible adapter calls to a local model server such as Ollama or another /v1-compatible endpoint.",
  localModelBaseUrl: "Base URL for the local OpenAI-compatible API. Include the /v1 suffix when your server expects it.",
  localModelApiKey: "Optional API key value for local OpenAI-compatible servers. Ollama usually accepts any non-empty placeholder.",
